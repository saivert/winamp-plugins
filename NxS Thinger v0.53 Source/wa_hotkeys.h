...
/* wa_hotkeys.h (modified 15/05/2004 by Darren Owen aka DrO)
**
** Adds a working function for adding a global hotkey though it can be expanded on :)
** tidied up the file a bit and also example of how to detect the hotkey message
*/
